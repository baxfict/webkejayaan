      ...
      <div class="row">
        ...
        <form action="<?=base_url('update/'.$artikel["id"])?>" method="post" enctype="multipart/form-data">
          ...
          <div class="mb-1">
            ...
            <input type="text" class="form-control" name="judul" id="exampleInputEmail1" aria-describedby="emailHelp" value="<?=$artikel["judul"]?>">
          </div>
          <div class="mb-1">
            <label for="exampleInputEmail1" class="form-label">Slug</label>
            <input type="text" class="form-control" name="slug" id="exampleInputEmail1" aria-describedby="emailHelp" value="<?=$artikel["slug"]?>">
          </div>
          <div class="form-group mb-2">
            <label for="exampleFormControlTextarea1">Isi Berita</label>
            <textarea class="form-control" name="isi" id="exampleFormControlTextarea1" rows="3" value=""><?=$artikel["isi"]?></textarea>
          </div>
